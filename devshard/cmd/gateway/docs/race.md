...
2. **Escalation** — the next armed trigger, suppressed while a pick is already running, and once the race is crowned, detached, at its attempt budget, or once a trusted host's refusal or rejection of the request rules out a retry.
