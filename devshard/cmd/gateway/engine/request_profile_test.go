...
func TestAPickCarriesTheRequestItServes(t *testing.T) {
	coordinator := &raceCoordinator{
		request:  raceRequest{Request: Request{RequestID: "request-3", Model: testModel, InputTokens: 12}},
		escrowID: "escrow-1",
	}
	...
	require.Equal(t, scheduler.RequestProfile{
		RequestID: "request-3", Model: testModel, Escrow: "escrow-1", InputTokens: 12, Params: "params",
	}, profile)
}
